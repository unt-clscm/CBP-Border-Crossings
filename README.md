...
Companion to [`../BTS-TransBorder`](../BTS-TransBorder). Tracks **U.S. Customs and Border Protection** northbound crossing counts (vehicles, pedestrians, containers) at Texas–Mexico ports of entry, 2013 to 2025.
...
├── 03-Processed-Data/           Final CSV + JSON (nb_crossings_2013_2025)
...
| Phase | Status |
|-------|--------|
| Phase 1 — Data Processing | Planned |
| Phase 2 — WebApp | Planned |
